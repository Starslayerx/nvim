  ...
  -- 展示 key mapping
  {
    ...
    config = function(_, opts)
      ...
      wk.add({
        ...
        { "<leader>lf", desc = "Peek Definition" },
        { "<leader>lh", desc = "Hover Documentation" },
        { "<leader>lr", desc = "References / Implementations" },
        { "<leader>ls", desc = "Definition in Horizontal Split" },
        { "<leader>lv", desc = "Definition in Vertical Split" },
        {
          "<leader>db",
          mode = "n",
          icon = function()
